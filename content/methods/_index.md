...
The next challenge, which was admittedly an afterthought, was determining whether a property management company operated in Bellingham, WA. There isn't an easy way to determine that as in some cases a company might not have a physical office in town or even in the state. One would need to find a way to get a list of all rental properties in the area, then search for the property management company and get its address.
