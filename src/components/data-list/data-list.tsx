...
export default function DataList({
  ...
  return (
    <div
      className={cn(
        `flex flex-col border-2 border-solid border-slate-500 rounded-lg bg-slate-200 px-10 mx-32`,
        className,
      )}
    >
      ...
      <div>
        <ol
          className={"justify-center items-center first:pt-2 last:pb-2 px-10"}
        >
