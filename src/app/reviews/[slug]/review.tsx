...
export async function Review(data: Company) {
  ...
  return (
    <Article className="container mx-auto py-10 review-summary">
      ...
      <div
        id="review-data-list"
        className="hidden md:flex grid-cols-1 grid-rows-2 items-center justify-center pt-4"
      >
        <ol className="text-sm lg:text-lg justify-center items-center md:space-x-4 text-lg">
          <li tabIndex={0}>
            <span className="m-1">
              <b>Review Count: </b>
              {data.review_count}
        ...
        {hasAdjustedReviewValue && (
          <span tabIndex={0} className="flex justify-center"> 
      ...
      >
        ...
        >
          <ol className="space-y-2 text-gray-500 list-none list-inside dark:text-gray-400 sm:text-lg !text-black">
            <li tabIndex={0}>
              <span className="m-1">
                <b>Review Count: </b>
                {data.review_count}
          ...
          <Link
            href={`/reviews/${data.slug}/data`}
            className="flex h-8 my-2 w-auto items-center justify-center rounded mx-1 bg-blue-500 px-2 text-white"
          >
            Raw Data
          </Link>
          {hasAdjustedReviewValue && (
